...
public class PPHolonomicDriveController {
     ...
     */
    public PPHolonomicDriveController(PIDController xController, PIDController yController, ProfiledPIDController rotationController){
    ...
    public ChassisSpeeds calculate(Pose2d currentPose, PathPlannerState referenceState){
        ...
        double rotationFeedback = this.rotationController.calculate(currentPose.getRotation().getRadians(), referenceState.holonomicRotation.getRadians());
